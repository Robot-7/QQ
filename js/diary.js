...
function pathConditions(){
	  /*console.log(n);*/
         ...
         console.log(getMonthByEnglish(calendarMonth.innerHTML)+1);
           if((activeDay==16 || activeDay==18 || activeDay==15 || activeDay==19 || activeDay==7 || activeDay==12 || activeDay==9 || activeDay==27) && getMonthByEnglish(calendarMonth.innerHTML)+1===11 && calendarYear.innerHTML==currentTime.getFullYear())
           {
